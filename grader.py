...
def compute_step_reward(
    ...
    domain_r = law_r = action_r = jurisdiction_r = evidence_r = penalty_r = 0.0
    ...
    if atype == ActionType.CLASSIFY_DOMAIN:
        ...
        action_r = score_action(
            ...
            gold.get("correct_action", "").value if hasattr(gold.get("correct_action", ""), "value") else str(gold.get("correct_action", "")),
            gold.get("secondary_action", "").value if hasattr(gold.get("secondary_action", ""), "value") else str(gold.get("secondary_action", "")),
        ) * 0.9
        ...
        jurisdiction_r = score_jurisdiction(
            ...
            gold.get("correct_jurisdiction", "").value if hasattr(gold.get("correct_jurisdiction", ""), "value") else str(gold.get("correct_jurisdiction", "")),
        ) * 0.9

    elif atype == ActionType.LIST_EVIDENCE:
        evidence_r = score_evidence(action.evidence_items, gold.get("key_evidence", [])) * 0.8
...
def grade_episode(
    ...
    correct_domain = gold["correct_domain"].value if hasattr(gold["correct_domain"], "value") else gold["correct_domain"]
